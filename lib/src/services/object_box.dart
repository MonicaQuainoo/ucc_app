import 'package:logged/objectbox.g.dart';
import 'package:logged/src/screens/models/active.dart';
...
class ObjectBox {
  ...
  Stream<List<Active>> getActives() {
    ...
    final builder = _activeBox.query().order(Active_.date, flags: Order.descending);
